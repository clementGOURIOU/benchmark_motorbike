...
###==================================================================
case2gen="profileExtrusion"   ## valid: complexProfile, profileExtrusion
                              ## and lidDrivenCavity
maxCo=5                     ## any value defined by user
solver="semiCoupledViscoelasticFoam" ## valid: 
...
control="tol"               ## valid: tol (tolerance) 
                            ## or iter (iterations)
nProcs=64                    ## any integer value defined by user
